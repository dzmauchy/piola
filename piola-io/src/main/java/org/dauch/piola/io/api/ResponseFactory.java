...
import org.dauch.piola.io.api.serde.*;
...
public final class ResponseFactory {
  ...
  public static Response read(ByteBuffer input, SerializationContext context) {
    ...
    return switch (code) {
      ...
      // topics
      case 1000 -> TopicInfoResponseSerde.read(input, context);
  ...
  public static void write(Response response, ByteBuffer output) {
    switch (response) {
      ...
      // topics
      case TopicInfoResponse r -> TopicInfoResponseSerde.write(r, output.putInt(1000));
